...
## Project Structure
    ...
    ├── testapiautostoryboa_94257  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_94257`
...
2. Clone this repo and `cd testapiautostoryboa_94257`
